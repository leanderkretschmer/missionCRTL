...
Das Script prüft Node/npm, versucht ein `npm install`, führt Tests aus und startet anschließend den Server auf `0.0.0.0:3000` (oder via `HOST`/`PORT` überschreibbar).
